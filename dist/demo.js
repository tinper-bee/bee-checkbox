	...
	var Demo1 = function (_Component) {
		...
		Demo1.prototype.render = function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_src2['default'],
					{ disabled: true, className: 'test' },
					' checkbox'
				),
				_react2['default'].createElement(
					_src2['default'],
					{ ref: 'test', checked: this.state.checkedFlag, onChange: this.onChange },
					' \u5168\u9009'
				),
				_react2['default'].createElement(
					_src2['default'],
					{ ref: 'test', indeterminate: true, onChange: this.onChange },
					' \u534A\u9009'
				)
			);
		};
